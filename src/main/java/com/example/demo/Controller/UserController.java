...
public class UserController {
    ...
    public ResponseEntity<?> getMovieInteractionInfor(@RequestParam(name = "userId") int userId,@RequestParam(name = "movieId") int movieId) {
    ...
    public ResponseEntity<?> getCommentsByMovieId(@RequestParam(name = "userId") int userId, @RequestParam(name = "movieId") int movieId) {
    ...
    public ResponseEntity<?> updateLikedRepo(@RequestParam(name = "userId") int userId, @RequestParam(name = "movieId") int movieId) {
    ...
    public ResponseEntity<?> updateSavedRepo(@RequestParam(name = "userId") int userId, @RequestParam(name = "movieId") int movieId) {
        CustomData<User> data = new CustomData<>();
        CustomResponse<User> response = new CustomResponse<>();
    ...
    public ResponseEntity<?> updateMovieViews(@RequestParam(name = "userId") int userId, @RequestParam(name = "movieId") int movieId) {
        CustomData<Movie> data = new CustomData<>();
        CustomResponse<Movie> response = new CustomResponse<>();
    ...
    public ResponseEntity<?> getAllMoviesByGenreId(@RequestParam(name = "userId") int userId, @RequestParam(name = "genreId") int genreId) {
        CustomData<List<Movie>> data = new CustomData<>();
        CustomResponse<List<Movie>> response = new CustomResponse<>();
    ...
    public String getWatchlistPage(@RequestParam(name = "userId") int userId) {
        User user = this.userService.findByUserId(userId);
        if(user!=null) {
            if(user.getState() != State.ACTIVE) {
                return "error";
