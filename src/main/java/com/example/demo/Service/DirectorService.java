...
public class DirectorService {
    ...
    public Director addDirector(Director director){
        if (directorRepo.findByName(director.getName()).isPresent()){
            return null;
        }
    ...
    public Director updateDirector(int id, Director director){
        ...
        Optional<Director> duplicateDirector = directorRepo.findByName(director.getName());
        if (duplicateDirector.isPresent() && duplicateDirector.get().getDirectorId() != id){
            return null;
        }
